...
unidade_origem = input("Unidade de origem (C para Celsius, F para Fahrenheit, K para Kelvin): ")
...
print(f"Temperatura: {temperatura:}° {unidade_origem.upper()}")
print(f"Temperatura convertida: {temperatura_convertida:}° {unidade_destino.upper()}")